...
> 日期：2026-08-16。状态：已批准实施（批次 0-9 核心完成；计划 v2 阶段 0-7 已完成——AUTHORITATIVE 生产默认 + 引擎循环入 C++ + 渲染 RHI；批 8 C-06 转发收尾：库存家族 10 动作接线 + 批 8-4 接线面收口判定；退役专项批 9-1/9-2 完成——SHADOW 对拍态与纯 Kotlin 旬结算路径删除，tick 结算恒走 C++ 单引擎终态；批 10-1~10-5 月变残留执行器增量下沉（S8 侦察/叛逃/偷盗/附庸 + S-15 清偿）；批 11-1~11-4 自动招募/秘境/AI 派遣/12 月自动购买 + 途中问题清偿（S-14 家族/S-19/S-18）；批 12-1~12-2 弟子购买/任务刷新下沉（C-11 shuffled 修复、S-19 特判移除）；批 12-3/12-4 战斗边界审计判定（任务完成/AI 兽战/洞天保持 Kotlin）；批 12-5 S 系列清偿（S-10~S-13 配置注入 C++）；批 12-6 对拍框架长期化（CI job）；收尾批（2026-09-02）：S-07/S-21 清偿 + 年变对拍外交簇换装真实（新增 T2-④/⑥⑦⑨ 对拍场景——首次整链对拍实锤并修复 C++ 两处 Kotlin 不等价：manual 交易 RNG 消费序缺口 + 交易/收购 pill 池序，新增 pillRecipesInTemplateOrder 模板序视图）+ 版本 4.01.12 发布，迁移主线全部收口；执行路径见 docs/cpp-engine.md 第 7 节）。

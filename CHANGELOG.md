...
### 变更
- 月俸忠诚改为每月±1（原每3次±1），矿工每月-1忠诚，入住住所每月+1忠诚

## [3.2.1] - 2026-05-27

### 变更
- 仓库建筑改为3x2格，容量显示移至标题栏右侧
- 驻守弟子标题右侧新增详情按钮描述防盗机制
- 偷盗触发改为道德和忠诚均低于30，脱离宗门改为按忠诚概率判定
- 新增被偷盗提示框，显示损失灵石数

## [3.2.0] - 2026-05-27

### 新增
- **仓库建筑**：4格/1000灵石/无建造上限，点击弹出半屏驻守界面，每座+50格仓库容量
- **仓库容量系统**：宗门仓库从2000格上限改为动态50+50×仓库数，超限物品直接遗失+弹窗通知
- **仓库驻守防盗**：偷盗时随机选仓库与驻守弟子1v1战斗，贼胜则偷盗成功，贼败则被捕

## [3.1.29] - 2026-05-27

### 新增
- 百战通神天赋实装：PVE战斗胜利后，拥有该天赋的幸存弟子随机属性+1（17个属性池：10技能+7战斗基底）

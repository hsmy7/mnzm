...
### Bug 修复
- 修复驻守弟子槽位：放入弟子后界面不更新（改为观察最新 gameData）
- 修复驻守弟子槽位：所有弟子显示同一张 fallback 图像（补 portraitRes 字段）
- 所有弟子槽位禁止同一弟子重复分配：建筑工人槽位、藏经阁槽位、进攻队伍、关卡探索、洞府探索均已加校验

## [3.0.28] - 2026-05-15

### 弟子槽位统一改造
- 所有弟子槽位（长老、执事、工人、驻守、进攻、关卡、任务等17个槽位）统一为弟子半身像+境界显示
- 槽位尺寸统一为固定大小，全界面一致
- 移除长老槽位内的额外属性文字（炼丹/炼器/灵植/采矿/道德）
- 战斗日志详情界面参战弟子槽位同步统一

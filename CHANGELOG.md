...
## [4.0.32] - 2026-07-01（versionCode=4032）

### 功能

- **新增宗门外交对话界面** — 在世界地图宗门卡片和外交界面各宗门卡片中新增「外交」按钮，点击打开半屏对话场景：左侧显示宗门等级图标、名称和弟子头像（圆形白框），右侧为对话气泡（使用新背景图素材），文本根据好感度等级动态变化，下方放置「结盟」和「送礼」按钮供玩家操作

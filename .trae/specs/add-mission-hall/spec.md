...
- 扩展GameData添加任务相关字段
- 扩展DiscipleStatus添加ON_MISSION状态
- 新增数据库迁移
...
#### 难度对应关系
| 难度 | 出现概率 | 任务时长 | 职务要求 | 境界要求 |
|-----|---------|---------|---------|---------|
| 黄级 | 50% | 3月 | 外门弟子/内门弟子 | 炼气及以上 |
| 玄级 | 43% | 7月 | 外门弟子/内门弟子 | 金丹及以上 |
| 地级 | 6% | 36月 | 内门弟子 | 炼虚及以上 |
| 天级 | 1% | 58月 | 内门弟子 | 大乘及以上 |
...
| 难度 | 状态要求 | 职务要求 | 境界要求 |
|-----|---------|---------|---------|
| 黄级 | 空闲（IDLE） | 外门弟子/内门弟子 | 炼气及以上 |
| 玄级 | 空闲（IDLE） | 外门弟子/内门弟子 | 金丹及以上 |
| 地级 | 空闲（IDLE） | 内门弟子 | 炼虚及以上 |
| 天级 | 空闲（IDLE） | 内门弟子 | 大乘及以上 |

#### Scenario: 成功派遣任务
- **WHEN** 玩家选择5名符合条件的弟子并确认派遣
- **THEN** 弟子状态变为ON_MISSION
- **AND** 任务开始计时
- **AND** 显示预计完成时间

#### Scenario: 派遣失败-弟子不符合条件
- **WHEN** 玩家选择不符合条件的弟子
- **THEN** 系统提示"弟子境界不足"或"弟子状态不允许"或"弟子职务不符合"
- **AND** 不执行派遣
...
| 玄级 | 1200灵石 | 60%概率获得1-2个道具（宝品及以下的功法/装备/丹药） | 5-10种（宝品及以下） |
| 地级 | 5000灵石 | 20%概率获得1个道具（地品及以下的功法/装备/丹药） | 1-5种（地品及以下） |
| 天级 | 20000灵石 | 20%概率获得1个道具（天品及以下的功法/装备/丹药） | 1-5种（天品及以下） |
...
| 黄级 | 无此难度任务 |
| 玄级 | 无此难度任务 |
| 地级 | 2-5种道具（地品至玄品的功法/装备） |
| 天级 | 1-2种道具（天品至地品的功法/装备） |
...
在现有DiscipleStatus枚举中添加ON_MISSION状态。

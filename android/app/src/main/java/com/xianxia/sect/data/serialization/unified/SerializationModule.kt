    ...
    private fun convertPill(pill: com.xianxia.sect.core.model.Pill): SerializablePill {
        return SerializablePill(
            ...
            effects = mapOf(
                ...
                "cultivationSpeedPercent" to pill.effects.cultivationSpeedPercent,
                "skillExpSpeedPercent" to pill.effects.skillExpSpeedPercent,
                "nurtureSpeedPercent" to pill.effects.nurtureSpeedPercent,
                "duration" to pill.effects.duration.toDouble(),
                "cannotStack" to if (pill.effects.cannotStack) 1.0 else 0.0,
                "cultivationAdd" to pill.effects.cultivationAdd.toDouble(),
                "skillExpAdd" to pill.effects.skillExpAdd.toDouble(),
                "nurtureAdd" to pill.effects.nurtureAdd.toDouble(),
                "extendLife" to pill.effects.extendLife.toDouble(),
                "physicalAttackAdd" to pill.effects.physicalAttackAdd.toDouble(),
                "magicAttackAdd" to pill.effects.magicAttackAdd.toDouble(),
                "physicalDefenseAdd" to pill.effects.physicalDefenseAdd.toDouble(),
                "magicDefenseAdd" to pill.effects.magicDefenseAdd.toDouble(),
                "hpAdd" to pill.effects.hpAdd.toDouble(),
                "mpAdd" to pill.effects.mpAdd.toDouble(),
                "speedAdd" to pill.effects.speedAdd.toDouble(),
                "critRateAdd" to pill.effects.critRateAdd,
                "critEffectAdd" to pill.effects.critEffectAdd,
                "healMaxHpPercent" to pill.effects.healMaxHpPercent,
                "mpRecoverMaxMpPercent" to pill.effects.mpRecoverMaxMpPercent,
                "intelligenceAdd" to pill.effects.intelligenceAdd.toDouble(),
                "charmAdd" to pill.effects.charmAdd.toDouble(),
                "loyaltyAdd" to pill.effects.loyaltyAdd.toDouble(),
                "comprehensionAdd" to pill.effects.comprehensionAdd.toDouble(),
                "artifactRefiningAdd" to pill.effects.artifactRefiningAdd.toDouble(),
                "pillRefiningAdd" to pill.effects.pillRefiningAdd.toDouble(),
                "spiritPlantingAdd" to pill.effects.spiritPlantingAdd.toDouble(),
                "teachingAdd" to pill.effects.teachingAdd.toDouble(),
                "moralityAdd" to pill.effects.moralityAdd.toDouble(),
                "revive" to if (pill.effects.revive) 1.0 else 0.0,
                "clearAll" to if (pill.effects.clearAll) 1.0 else 0.0,

...
class XianxiaApplication : Application() {
    ...
    override fun onCreate() {
        ...
        DiscipleAggregate.statsProvider = object : DiscipleStatsProvider {
            ...
            override fun getBreakthroughChance(disciple: com.xianxia.sect.core.model.Disciple, innerElderComprehension: Int, outerElderComprehensionBonus: Double, pillBonus: Double, adBonus: Double, griefBreakthroughPenalty: Double, masterDiscipleBonus: Double) = DiscipleStatCalculator.getBreakthroughChance(disciple, innerElderComprehension, outerElderComprehensionBonus, pillBonus, adBonus, griefBreakthroughPenalty, masterDiscipleBonus)
            override fun getBreakthroughChance(aggregate: DiscipleAggregate, innerElderComprehension: Int, outerElderComprehensionBonus: Double, pillBonus: Double, adBonus: Double, griefBreakthroughPenalty: Double, masterDiscipleBonus: Double) = DiscipleStatCalculator.getBreakthroughChance(aggregate, innerElderComprehension, outerElderComprehensionBonus, pillBonus, adBonus, griefBreakthroughPenalty, masterDiscipleBonus)
        }
        ...
        SpriteResRegistry.initialize(
            ...
            herbSprites = mapOf(
                ...
                "spiritGrass4" to R.drawable.herb_spiritgrass4,
                "spiritGrass5" to R.drawable.herb_spiritgrass5,
                "spiritGrass6" to R.drawable.herb_spiritgrass6,
                ...
                "spiritFlower4" to R.drawable.herb_spiritflower4,
                "spiritFlower5" to R.drawable.herb_spiritflower5,
                "spiritFlower6" to R.drawable.herb_spiritflower6,
                ...
                "spiritFruit4" to R.drawable.herb_spiritfruit4,
                "spiritFruit5" to R.drawable.herb_spiritfruit5,
                "spiritFruit6" to R.drawable.herb_spiritfruit6
            ),
            seedSprites = mapOf(
                ...
                "spiritGrass4" to R.drawable.seed_spiritgrass4,
                "spiritGrass5" to R.drawable.seed_spiritgrass5,
                "spiritGrass6" to R.drawable.seed_spiritgrass6,
                ...
                "spiritFlower4" to R.drawable.seed_spiritflower4,
                "spiritFlower5" to R.drawable.seed_spiritflower5,
                "spiritFlower6" to R.drawable.seed_spiritflower6,
                ...
                "spiritFruit4" to R.drawable.seed_spiritfruit4,
                "spiritFruit5" to R.drawable.seed_spiritfruit5,
                "spiritFruit6" to R.drawable.seed_spiritfruit6
            ),
            growingSprites = mapOf(
                ...
                "spiritGrass4" to R.drawable.growing_spiritgrass4,
                "spiritGrass5" to R.drawable.growing_spiritgrass5,
                "spiritGrass6" to R.drawable.growing_spiritgrass6,
                ...
                "spiritFlower4" to R.drawable.growing_spiritflower4,
                "spiritFlower5" to R.drawable.growing_spiritflower5,
                "spiritFlower6" to R.drawable.growing_spiritflower6,
                ...
                "spiritFruit4" to R.drawable.growing_spiritfruit4,
                "spiritFruit5" to R.drawable.growing_spiritfruit5,

...
class SettlementCache(state: MutableGameState) {
    ...
    private fun calculateCultivationRate(
        ...
        return com.xianxia.sect.core.engine.DiscipleStatCalculator.calculateCultivationSpeed(
            disciple = disciple,
    ...
    private fun calculatePreachingBonuses(
        ...
        return com.xianxia.sect.core.engine.DiscipleStatCalculator.calculatePreachingBonus(
            disciple = disciple,

...
object ForgeRecipeDatabase {
    ...
    private val tier1Recipes = listOf(
        ...
        ForgeRecipe("clothRobe", "灵竹衣", EquipmentSlot.ARMOR, 1, 1, "灵竹纤维制成的衣物", mapOf("turtleShell0" to 3, "snakeScale0" to 2), 2, 0.70),
    ...
    private val tier2Recipes = listOf(
        ...
        ForgeRecipe("spiritRobe", "灵丝袍", EquipmentSlot.ARMOR, 2, 2, "灵蚕丝织成的法袍", mapOf("turtleShell1" to 4, "snakeScale1" to 2), 5, 0.65),
    ...
    private val tier3Recipes = listOf(
        ...
        ForgeRecipe("starRobe", "星辰袍", EquipmentSlot.ARMOR, 3, 3, "绣有星辰图案的法袍", mapOf("bearHide2" to 3, "snakeScale2" to 3, "bearCore2" to 2), 9, 0.60),
    ...
    private val tier4Recipes = listOf(
        ...
        ForgeRecipe("moonRobe", "月华袍", EquipmentSlot.ARMOR, 4, 4, "吸收月华之力织成的法袍", mapOf("bearHide3" to 5, "snakeScale3" to 3, "bearCore3" to 3), 18, 0.35),
    ...
    private val tier5Recipes = listOf(
        ...
        ForgeRecipe("voidShadowRobe", "定海铠", EquipmentSlot.ARMOR, 5, 5, "定海之力凝聚的铠甲", mapOf("bearHide4" to 5, "snakeScale4" to 3, "bearCore4" to 3, "foxCore4" to 2), 30, 0.30),
    ...
    private val tier6Recipes = listOf(
        ...
        ForgeRecipe("primordialArmor", "苍罡铠", EquipmentSlot.ARMOR, 6, 6, "苍罡之力凝聚的神甲", mapOf("bearHide5" to 8, "bearBone5" to 5, "bearCore5" to 3, "dragonClaw5" to 3), 48, 0.25),
        ...
        ForgeRecipe("chaosRobe", "云影袍", EquipmentSlot.ARMOR, 6, 6, "云影交织的法袍", mapOf("bearHide5" to 6, "snakeScale5" to 4, "bearCore5" to 4, "dragonClaw5" to 3), 48, 0.25),
        ...
        ForgeRecipe("chaosStepBoots", "鹤岚靴", EquipmentSlot.BOOTS, 6, 6, "鹤翔岚雾而行", mapOf("wolfHide5" to 6, "eagleClaw5" to 4, "wolfCore5" to 4, "dragonClaw5" to 3), 48, 0.25),

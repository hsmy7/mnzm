...
object BeastMaterialDatabase {
    ...
    private val allMaterials: List<BeastMaterial> = listOf(
        ...
        // ========== 狼妖材料（高速度型）==========
        // 凡品
        BeastMaterial("wolfHide0", "凡狼皮", 1, 1, "hide", "凡品狼妖的皮毛，轻便迅捷", "🟫", 1.0),
        BeastMaterial("wolfBone0", "凡狼骨", 1, 1, "bone", "凡品狼妖的骨骼，轻而坚韧", "🦴", 1.0),
        BeastMaterial("wolfTooth0", "凡狼牙", 1, 1, "tooth", "凡品狼妖的利齿，锋利迅捷", "🦷", 0.8),
        BeastMaterial("wolfCore0", "凡狼内丹", 1, 1, "core", "凡品狼妖的内丹，蕴含迅捷灵力", "🔮", 0.5),
        // 灵品
        BeastMaterial("wolfHide1", "灵狼皮", 2, 2, "hide", "灵品狼妖的皮毛，蕴含灵气与迅捷", "🟫", 0.8),
        BeastMaterial("wolfBone1", "灵狼骨", 2, 2, "bone", "灵品狼妖的骨骼，轻盈坚韧", "🦴", 0.8),
        BeastMaterial("wolfTooth1", "灵狼牙", 2, 2, "tooth", "灵品狼妖的利齿，快如闪电", "🦷", 0.6),
        BeastMaterial("wolfCore1", "灵狼内丹", 2, 2, "core", "灵品狼妖的内丹，蕴含浓郁迅捷灵力", "🔮", 0.4),
        // 宝品
        BeastMaterial("wolfHide2", "宝狼皮", 3, 3, "hide", "宝品狼妖的皮毛，珍贵且蕴含速度之力", "🟫", 0.6),
        BeastMaterial("wolfBone2", "宝狼骨", 3, 3, "bone", "宝品狼妖的骨骼，轻若鸿毛", "🦴", 0.6),
        BeastMaterial("wolfTooth2", "宝狼牙", 3, 3, "tooth", "宝品狼妖的利齿，迅疾如风", "🦷", 0.5),
        BeastMaterial("wolfCore2", "宝狼内丹", 3, 3, "core", "宝品狼妖的内丹，蕴含强大迅捷之力", "🔮", 0.3),
        // 玄品
        BeastMaterial("wolfHide3", "玄狼皮", 4, 4, "hide", "玄品狼妖的皮毛，蕴含玄妙迅捷之力", "🟫", 0.4),
        BeastMaterial("wolfBone3", "玄狼骨", 4, 4, "bone", "玄品狼妖的骨骼，蕴含玄妙轻盈", "🦴", 0.4),
        BeastMaterial("wolfTooth3", "玄狼牙", 4, 4, "tooth", "玄品狼妖的利齿，蕴含玄妙速度", "🦷", 0.3),
        BeastMaterial("wolfCore3", "玄狼内丹", 4, 4, "core", "玄品狼妖的内丹，蕴含玄妙迅捷灵力", "🔮", 0.2),
        // 地品
        BeastMaterial("wolfHide4", "地狼皮", 5, 5, "hide", "地品狼妖的皮毛，蕴含大地迅捷之力", "🟫", 0.25),
        BeastMaterial("wolfBone4", "地狼骨", 5, 5, "bone", "地品狼妖的骨骼，蕴含大地轻盈", "🦴", 0.25),
        BeastMaterial("wolfTooth4", "地狼牙", 5, 5, "tooth", "地品狼妖的利齿，蕴含大地速度", "🦷", 0.2),
        BeastMaterial("wolfCore4", "地狼内丹", 5, 5, "core", "地品狼妖的内丹，蕴含大地迅捷灵力", "🔮", 0.12),
        // 天品
        BeastMaterial("wolfHide5", "天狼皮", 6, 6, "hide", "天品狼妖的皮毛，蕴含天道迅捷之力", "🟫", 0.12),
        BeastMaterial("wolfBone5", "天狼骨", 6, 6, "bone", "天品狼妖的骨骼，蕴含天道轻盈", "🦴", 0.12),
        BeastMaterial("wolfTooth5", "天狼牙", 6, 6, "tooth", "天品狼妖的利齿，蕴含天道速度", "🦷", 0.1),
        BeastMaterial("wolfCore5", "天狼内丹", 6, 6, "core", "天品狼妖的内丹，蕴含天道迅捷灵力", "🔮", 0.06),
        ...
        // ========== 熊妖材料（高防御型）==========
        // 凡品
        BeastMaterial("bearHide0", "凡熊皮", 1, 1, "hide", "凡品熊妖的皮毛，厚实坚韧", "🟫", 1.0),
        BeastMaterial("bearBone0", "凡熊骨", 1, 1, "bone", "凡品熊妖的骨骼，粗壮坚硬", "🦴", 1.0),
        BeastMaterial("bearClaw0", "凡熊掌", 1, 1, "claw", "凡品熊妖的熊掌，力大无穷", "🐾", 0.8),
        BeastMaterial("bearCore0", "凡熊内丹", 1, 1, "core", "凡品熊妖的内丹，蕴含坚韧灵力", "🔮", 0.5),
        // 灵品
        BeastMaterial("bearHide1", "灵熊皮", 2, 2, "hide", "灵品熊妖的皮毛，蕴含灵气与坚韧", "🟫", 0.8),
        BeastMaterial("bearBone1", "灵熊骨", 2, 2, "bone", "灵品熊妖的骨骼，坚如磐石", "🦴", 0.8),
        BeastMaterial("bearClaw1", "灵熊掌", 2, 2, "claw", "灵品熊妖的熊掌，威力惊人", "🐾", 0.6),
        BeastMaterial("bearCore1", "灵熊内丹", 2, 2, "core", "灵品熊妖的内丹，蕴含浓郁坚韧灵力", "🔮", 0.4),
        // 宝品
        BeastMaterial("bearHide2", "宝熊皮", 3, 3, "hide", "宝品熊妖的皮毛，珍贵且蕴含强大防御", "🟫", 0.6),
        BeastMaterial("bearBone2", "宝熊骨", 3, 3, "bone", "宝品熊妖的骨骼，坚不可摧", "🦴", 0.6),
        BeastMaterial("bearClaw2", "宝熊掌", 3, 3, "claw", "宝品熊妖的熊掌，力能碎山", "🐾", 0.5),
        BeastMaterial("bearCore2", "宝熊内丹", 3, 3, "core", "宝品熊妖的内丹，蕴含强大坚韧之力", "🔮", 0.3),
        // 玄品
        BeastMaterial("bearHide3", "玄熊皮", 4, 4, "hide", "玄品熊妖的皮毛，蕴含玄妙坚韧之力", "🟫", 0.4),
        BeastMaterial("bearBone3", "玄熊骨", 4, 4, "bone", "玄品熊妖的骨骼，蕴含玄妙坚固", "🦴", 0.4),
        BeastMaterial("bearClaw3", "玄熊掌", 4, 4, "claw", "玄品熊妖的熊掌，蕴含玄妙力量", "🐾", 0.3),
        BeastMaterial("bearCore3", "玄熊内丹", 4, 4, "core", "玄品熊妖的内丹，蕴含玄妙坚韧灵力", "🔮", 0.2),
        // 地品
        BeastMaterial("bearHide4", "地熊皮", 5, 5, "hide", "地品熊妖的皮毛，蕴含大地坚韧之力", "🟫", 0.25),
        BeastMaterial("bearBone4", "地熊骨", 5, 5, "bone", "地品熊妖的骨骼，蕴含大地坚固", "🦴", 0.25),
        BeastMaterial("bearClaw4", "地熊掌", 5, 5, "claw", "地品熊妖的熊掌，蕴含大地力量", "🐾", 0.2),
        BeastMaterial("bearCore4", "地熊内丹", 5, 5, "core", "地品熊妖的内丹，蕴含大地坚韧灵力", "🔮", 0.12),
        // 天品
        BeastMaterial("bearHide5", "天熊皮", 6, 6, "hide", "天品熊妖的皮毛，蕴含天道坚韧之力", "🟫", 0.12),
        BeastMaterial("bearBone5", "天熊骨", 6, 6, "bone", "天品熊妖的骨骼，蕴含天道坚固", "🦴", 0.12),
        BeastMaterial("bearClaw5", "天熊掌", 6, 6, "claw", "天品熊妖的熊掌，蕴含天道力量", "🐾", 0.1),
        BeastMaterial("bearCore5", "天熊内丹", 6, 6, "core", "天品熊妖的内丹，蕴含天道坚韧灵力", "🔮", 0.06),

        // ========== 鹰妖材料（暴击/速度型）==========
        // 凡品
        BeastMaterial("eagleFeather0", "凡鹰羽", 1, 1, "feather", "凡品鹰妖的羽毛，轻盈锐利", "🪶", 1.0),
        BeastMaterial("eagleBone0", "凡鹰骨", 1, 1, "bone", "凡品鹰妖的骨骼，轻而坚固", "🦴", 1.0),
        BeastMaterial("eagleClaw0", "凡鹰爪", 1, 1, "claw", "凡品鹰妖的利爪，锋利如钩", "🐾", 0.8),
        BeastMaterial("eagleCore0", "凡鹰内丹", 1, 1, "core", "凡品鹰妖的内丹，蕴含锐利灵力", "🔮", 0.5),
        // 灵品
        BeastMaterial("eagleFeather1", "灵鹰羽", 2, 2, "feather", "灵品鹰妖的羽毛，蕴含灵气与锐利", "🪶", 0.8),
        BeastMaterial("eagleBone1", "灵鹰骨", 2, 2, "bone", "灵品鹰妖的骨骼，轻盈坚固", "🦴", 0.8),
        BeastMaterial("eagleClaw1", "灵鹰爪", 2, 2, "claw", "灵品鹰妖的利爪，快如闪电", "🐾", 0.6),
        BeastMaterial("eagleCore1", "灵鹰内丹", 2, 2, "core", "灵品鹰妖的内丹，蕴含浓郁锐利灵力", "🔮", 0.4),
        // 宝品
        BeastMaterial("eagleFeather2", "宝鹰羽", 3, 3, "feather", "宝品鹰妖的羽毛，珍贵且蕴含强大锐利", "🪶", 0.6),
        BeastMaterial("eagleBone2", "宝鹰骨", 3, 3, "bone", "宝品鹰妖的骨骼，轻若鸿毛", "🦴", 0.6),
        BeastMaterial("eagleClaw2", "宝鹰爪", 3, 3, "claw", "宝品鹰妖的利爪，迅疾如风", "🐾", 0.5),
        BeastMaterial("eagleCore2", "宝鹰内丹", 3, 3, "core", "宝品鹰妖的内丹，蕴含强大锐利之力", "🔮", 0.3),
        // 玄品
        BeastMaterial("eagleFeather3", "玄鹰羽", 4, 4, "feather", "玄品鹰妖的羽毛，蕴含玄妙锐利之力", "🪶", 0.4),
        BeastMaterial("eagleBone3", "玄鹰骨", 4, 4, "bone", "玄品鹰妖的骨骼，蕴含玄妙轻盈", "🦴", 0.4),
        BeastMaterial("eagleClaw3", "玄鹰爪", 4, 4, "claw", "玄品鹰妖的利爪，蕴含玄妙速度", "🐾", 0.3),
        BeastMaterial("eagleCore3", "玄鹰内丹", 4, 4, "core", "玄品鹰妖的内丹，蕴含玄妙锐利灵力", "🔮", 0.2),
        // 地品
        BeastMaterial("eagleFeather4", "地鹰羽", 5, 5, "feather", "地品鹰妖的羽毛，蕴含大地锐利之力", "🪶", 0.25),
        BeastMaterial("eagleBone4", "地鹰骨", 5, 5, "bone", "地品鹰妖的骨骼，蕴含大地轻盈", "🦴", 0.25),
        BeastMaterial("eagleClaw4", "地鹰爪", 5, 5, "claw", "地品鹰妖的利爪，蕴含大地速度", "🐾", 0.2),
        BeastMaterial("eagleCore4", "地鹰内丹", 5, 5, "core", "地品鹰妖的内丹，蕴含大地锐利灵力", "🔮", 0.12),
        // 天品
        BeastMaterial("eagleFeather5", "天鹰羽", 6, 6, "feather", "天品鹰妖的羽毛，蕴含天道锐利之力", "🪶", 0.12),
        BeastMaterial("eagleBone5", "天鹰骨", 6, 6, "bone", "天品鹰妖的骨骼，蕴含天道轻盈", "🦴", 0.12),
        BeastMaterial("eagleClaw5", "天鹰爪", 6, 6, "claw", "天品鹰妖的利爪，蕴含天道速度", "🐾", 0.1),
        BeastMaterial("eagleCore5", "天鹰内丹", 6, 6, "core", "天品鹰妖的内丹，蕴含天道锐利灵力", "🔮", 0.06),

        // ========== 狐妖材料（幻魅型）==========
        // 凡品
        BeastMaterial("foxHide0", "凡狐皮", 1, 1, "hide", "凡品狐妖的皮毛，柔软光滑", "🟥", 1.0),
        BeastMaterial("foxBone0", "凡狐骨", 1, 1, "bone", "凡品狐妖的骨骼，轻盈灵动", "🦴", 1.0),
        BeastMaterial("foxTail0", "凡狐尾", 1, 1, "tail", "凡品狐妖的尾巴，柔软迷人", "🦊", 0.8),
        BeastMaterial("foxCore0", "凡狐内丹", 1, 1, "core", "凡品狐妖的内丹，蕴含幻魅灵力", "🔮", 0.5),
        // 灵品
        BeastMaterial("foxHide1", "灵狐皮", 2, 2, "hide", "灵品狐妖的皮毛，蕴含灵气与幻魅", "🟥", 0.8),
        BeastMaterial("foxBone1", "灵狐骨", 2, 2, "bone", "灵品狐妖的骨骼，轻盈灵动", "🦴", 0.8),
        BeastMaterial("foxTail1", "灵狐尾", 2, 2, "tail", "灵品狐妖的尾巴，幻魅迷人", "🦊", 0.6),
        BeastMaterial("foxCore1", "灵狐内丹", 2, 2, "core", "灵品狐妖的内丹，蕴含浓郁幻魅灵力", "🔮", 0.4),
        // 宝品
        BeastMaterial("foxHide2", "宝狐皮", 3, 3, "hide", "宝品狐妖的皮毛，珍贵且蕴含强大幻魅", "🟥", 0.6),
        BeastMaterial("foxBone2", "宝狐骨", 3, 3, "bone", "宝品狐妖的骨骼，轻若鸿毛", "🦴", 0.6),
        BeastMaterial("foxTail2", "宝狐尾", 3, 3, "tail", "宝品狐妖的尾巴，幻魅万千", "🦊", 0.5),
        BeastMaterial("foxCore2", "宝狐内丹", 3, 3, "core", "宝品狐妖的内丹，蕴含强大幻魅之力", "🔮", 0.3),
        // 玄品
        BeastMaterial("foxHide3", "玄狐皮", 4, 4, "hide", "玄品狐妖的皮毛，蕴含玄妙幻魅之力", "🟥", 0.4),
        BeastMaterial("foxBone3", "玄狐骨", 4, 4, "bone", "玄品狐妖的骨骼，蕴含玄妙灵动", "🦴", 0.4),
        BeastMaterial("foxTail3", "玄狐尾", 4, 4, "tail", "玄品狐妖的尾巴，蕴含玄妙幻魅", "🦊", 0.3),
        BeastMaterial("foxCore3", "玄狐内丹", 4, 4, "core", "玄品狐妖的内丹，蕴含玄妙幻魅灵力", "🔮", 0.2),
        // 地品
        BeastMaterial("foxHide4", "地狐皮", 5, 5, "hide", "地品狐妖的皮毛，蕴含大地幻魅之力", "🟥", 0.25),
        BeastMaterial("foxBone4", "地狐骨", 5, 5, "bone", "地品狐妖的骨骼，蕴含大地灵动", "🦴", 0.25),
        BeastMaterial("foxTail4", "地狐尾", 5, 5, "tail", "地品狐妖的尾巴，蕴含大地幻魅", "🦊", 0.2),
        BeastMaterial("foxCore4", "地狐内丹", 5, 5, "core", "地品狐妖的内丹，蕴含大地幻魅灵力", "🔮", 0.12),
        // 天品
        BeastMaterial("foxHide5", "天狐皮", 6, 6, "hide", "天品狐妖的皮毛，蕴含天道幻魅之力", "🟥", 0.12),
        BeastMaterial("foxBone5", "天狐骨", 6, 6, "bone", "天品狐妖的骨骼，蕴含天道灵动", "🦴", 0.12),
        BeastMaterial("foxTail5", "天狐尾", 6, 6, "tail", "天品狐妖的尾巴，蕴含天道幻魅", "🦊", 0.1),
        BeastMaterial("foxCore5", "天狐内丹", 6, 6, "core", "天品狐妖的内丹，蕴含天道幻魅灵力", "🔮", 0.06),

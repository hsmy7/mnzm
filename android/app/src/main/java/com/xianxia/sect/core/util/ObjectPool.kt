...
class TypedMapPool<K, V>(
    ...
    private val factory = object : ObjectPool.PoolFactory<MutableMap<K, V>> {
        override fun create(): MutableMap<K, V> = HashMap()
        override fun reset(instance: MutableMap<K, V>) {
            instance.clear()
        }
        override fun validate(instance: MutableMap<K, V>): Boolean = true
    }
...
class TypedListPool<T>(
    ...
    private val factory = object : ObjectPool.PoolFactory<MutableList<T>> {
        override fun create(): MutableList<T> = ArrayList()
        override fun reset(instance: MutableList<T>) {
            instance.clear()
        }
        override fun validate(instance: MutableList<T>): Boolean = true
    }
...
class StringBuilderPool(
    ...
    private val factory = object : ObjectPool.PoolFactory<StringBuilder> {
        override fun create(): StringBuilder = StringBuilder(256)
        override fun reset(instance: StringBuilder) {
            instance.clear()
        }

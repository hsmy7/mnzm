...
class SaveDataConverter @Inject constructor() {
    ...
    private fun convertGameData(gameData: com.xianxia.sect.core.model.GameData?): SerializableGameData {
        ...
        return SerializableGameData(
            ...
            tradingSellList = gameData.tradingSellList?.map { convertTradingItem(it) } ?: emptyList(),
            tradingBuyList = gameData.tradingBuyList?.map { convertTradingItem(it) } ?: emptyList(),
            tradeLogs = gameData.tradeLogs?.map { convertTradeLog(it) } ?: emptyList(),
            ...
            lastMissionRefreshYear = gameData.lastMissionRefreshYear ?: 0
        )
    }
    ...
    private fun convertBackGameData(data: SerializableGameData): com.xianxia.sect.core.model.GameData {
        return com.xianxia.sect.core.model.GameData(
            ...
            tradingSellList = data.tradingSellList.map { convertBackTradingItem(it) },
            tradingBuyList = data.tradingBuyList.map { convertBackTradingItem(it) },
            tradeLogs = data.tradeLogs.map { convertBackTradeLog(it) },
            ...
            lastMissionRefreshYear = data.lastMissionRefreshYear
        )
    }
    ...
    private fun convertTradingItem(item: com.xianxia.sect.core.model.TradingItem): SerializableTradingItem {
        return SerializableTradingItem(
            id = item.id ?: "",
            itemId = item.itemId ?: "",
            name = item.name ?: "",
            type = item.type ?: "",
    ...
    private fun convertBackTradingItem(data: SerializableTradingItem): com.xianxia.sect.core.model.TradingItem {
        return com.xianxia.sect.core.model.TradingItem(
            id = data.id,
            itemId = data.itemId,
            name = data.name,
            type = data.type,
    ...
    private fun convertTradeLog(log: com.xianxia.sect.core.model.TradeLog): SerializableTradeLog {
        return SerializableTradeLog(
            id = log.id ?: "",
            ...
            spiritStonesBefore = log.spiritStonesBefore ?: 0L,
            spiritStonesAfter = log.spiritStonesAfter ?: 0L
        )
    }
    
    private fun convertBackTradeLog(data: SerializableTradeLog): com.xianxia.sect.core.model.TradeLog {
        return com.xianxia.sect.core.model.TradeLog(
            id = data.id,
            timestamp = data.timestamp,
            type = data.type,
            itemId = data.itemId,
            ...
            spiritStonesBefore = data.spiritStonesBefore,
            spiritStonesAfter = data.spiritStonesAfter
        )
    }
    ...
    private fun convertElderSlots(slots: com.xianxia.sect.core.model.ElderSlots?): SerializableElderSlots {
        ...
        return SerializableElderSlots(
            ...
            libraryElder = slots.libraryElder,
            ...
            libraryDisciples = slots.libraryDisciples?.map { convertDirectDiscipleSlot(it) } ?: emptyList(),
    ...
    private fun convertBackElderSlots(data: SerializableElderSlots): com.xianxia.sect.core.model.ElderSlots {
        return com.xianxia.sect.core.model.ElderSlots(
            ...
            libraryElder = data.libraryElder,
            ...
            libraryDisciples = data.libraryDisciples.map { convertBackDirectDiscipleSlot(it) },
    ...
    private fun convertLibrarySlot(slot: com.xianxia.sect.core.model.LibrarySlot): SerializableLibrarySlot {
        return SerializableLibrarySlot(
            ...
            discipleId = slot.discipleId,
            discipleName = slot.discipleName ?: "",
            efficiency = slot.efficiency ?: 0.0
        )
    }
    ...
    private fun convertBackBuildingSlot(data: SerializableBuildingSlot): com.xianxia.sect.core.model.BuildingSlot {
        return com.xianxia.sect.core.model.BuildingSlot(
            id = data.id,
            type = safeEnumValueOf(data.type, com.xianxia.sect.core.model.SlotType.IDLE, "type", "BuildingSlot"),
            discipleId = data.discipleId,
            discipleName = data.discipleName,
            startYear = data.startYear,
            startMonth = data.startMonth,
    ...
    private fun convertBackActiveMission(data: SerializableActiveMission): com.xianxia.sect.core.model.ActiveMission {
        return com.xianxia.sect.core.model.ActiveMission(
            ...
            missionType = com.xianxia.sect.core.model.MissionType.ESCORT,
            difficulty = com.xianxia.sect.core.model.MissionDifficulty.YELLOW,
            discipleIds = data.assignedDisciples,
            discipleNames = data.assignedDisciples.map { "" },
            startYear = data.startYear,
            startMonth = data.startMonth,
    ...
    private fun convertBackMission(data: SerializableMission): com.xianxia.sect.core.model.Mission {
        return com.xianxia.sect.core.model.Mission(
            id = data.id,
            type = com.xianxia.sect.core.model.MissionType.ESCORT,
            name = data.name,
            description = data.description,
            difficulty = com.xianxia.sect.core.model.MissionDifficulty.entries.getOrNull(data.difficulty) ?: com.xianxia.sect.core.model.MissionDifficulty.YELLOW,
            minRealm = 9,
            duration = data.duration,
            rewards = com.xianxia.sect.core.model.MissionRewardConfig()
        )

...
class ProductionTransaction(
    ...
    fun commit(): Result<ProductionTransactionResult> {
        if (isCommitted) {
        ...
        isCommitted = true
        return Result.success(ProductionTransactionResult(
            materials = materials,
            slot = slot,
...
class ProductionTransactionManager {
    ...
    ): Result<Pair<T, ProductionTransactionResult>> {
    ...
    ): Result<ProductionTransactionResult> {

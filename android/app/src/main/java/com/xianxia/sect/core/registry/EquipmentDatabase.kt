...
object EquipmentDatabase {
    ...
    val weapons: Map<String, EquipmentTemplate> = mapOf(
        ...
        "crystalOrb" to EquipmentTemplate("crystalOrb", "碧木扇", EquipmentSlot.WEAPON, 1, magicAttack = 14, critChance = 0.04, description = "蕴含微量灵气的水晶球，易触发暴击", price = 3600),
        ...
        "frostBlade" to EquipmentTemplate("frostBlade", "青碧刃", EquipmentSlot.WEAPON, 3, physicalAttack = 92, critChance = 0.06, description = "蕴含寒冰之力的宝刀，物理攻击力出众", price = 64800),
        ...
        "frostOrb" to EquipmentTemplate("frostOrb", "玄冰扇", EquipmentSlot.WEAPON, 3, magicAttack = 136, critChance = 0.09, description = "蕴含玄冰之力的宝珠，攻击易暴击", price = 64800),
        ...
        "voidStaff" to EquipmentTemplate("voidStaff", "虚华杖", EquipmentSlot.WEAPON, 4, magicAttack = 285, critChance = 0.08, description = "可撕裂虚空的法杖，法术攻击力出众", price = 259200),
        "phoenixFan" to EquipmentTemplate("phoenixFan", "凰焰扇", EquipmentSlot.WEAPON, 4, magicAttack = 420, critChance = 0.12, description = "凤凰羽毛制成的神扇，攻击易暴击", price = 259200),

        "dragonSlayer" to EquipmentTemplate("dragonSlayer", "凤炎刃", EquipmentSlot.WEAPON, 5, physicalAttack = 880, critChance = 0.10, description = "传说中屠龙的绝世神兵，物理攻击力无双", price = 1036800),
        ...
        "phoenixWing" to EquipmentTemplate("phoenixWing", "阴阳扇", EquipmentSlot.WEAPON, 5, magicAttack = 880, critChance = 0.10, description = "凤凰羽翼化作的神兵，法术攻击力出众", price = 1036800),
        "celestialOrb" to EquipmentTemplate("celestialOrb", "天玄杖", EquipmentSlot.WEAPON, 5, magicAttack = 1280, critChance = 0.15, description = "凝聚星辰之力的宝珠，攻击易暴击", price = 1036800),
        ...
        "chaosBlade" to EquipmentTemplate("chaosBlade", "玄玉刃", EquipmentSlot.WEAPON, 6, physicalAttack = 3980, critChance = 0.18, description = "开天辟地时的混沌之刃，暴击率超凡入圣", price = 6000000),
        "primordialStaff" to EquipmentTemplate("primordialStaff", "天星杖", EquipmentSlot.WEAPON, 6, magicAttack = 2700, critChance = 0.13, description = "鸿蒙初开时诞生的法杖，法术攻击力无双", price = 6000000),
        "yinYangOrb" to EquipmentTemplate("yinYangOrb", "天玄扇", EquipmentSlot.WEAPON, 6, magicAttack = 3980, critChance = 0.18, description = "蕴含阴阳大道的至宝，攻击易暴击", price = 6000000)
    )

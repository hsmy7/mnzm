...
object EquipmentDatabase {
    ...
    val weapons: Map<String, EquipmentTemplate> = mapOf(
        ...
        "crystalOrb" to EquipmentTemplate("crystalOrb", "碧木扇", EquipmentSlot.WEAPON, 1, magicAttack = 14, critChance = 0.04, description = "碧木炼制的灵扇，蕴含微量灵气，易触发暴击", price = 3600),
        ...
        "frostBlade" to EquipmentTemplate("frostBlade", "青碧刃", EquipmentSlot.WEAPON, 3, physicalAttack = 92, critChance = 0.06, description = "蕴含青碧灵力的宝刀，物理攻击力出众", price = 64800),
        ...
        "thunderStaff" to EquipmentTemplate("thunderStaff", "玄雷杖", EquipmentSlot.WEAPON, 3, magicAttack = 92, critChance = 0.06, description = "可召唤雷电的法杖，法术攻击力强大", price = 64800),
        "frostOrb" to EquipmentTemplate("frostOrb", "玄冰扇", EquipmentSlot.WEAPON, 3, magicAttack = 136, critChance = 0.09, description = "蕴含玄冰之力的宝扇，攻击易暴击", price = 64800),
        ...
        "voidStaff" to EquipmentTemplate("voidStaff", "虚华杖", EquipmentSlot.WEAPON, 4, magicAttack = 285, critChance = 0.08, description = "虚华流转的玄妙法杖，法术攻击力出众", price = 259200),
        "phoenixFan" to EquipmentTemplate("phoenixFan", "凰焰扇", EquipmentSlot.WEAPON, 4, magicAttack = 420, critChance = 0.12, description = "凰焰淬炼的神扇，攻击易暴击", price = 259200),

        "dragonSlayer" to EquipmentTemplate("dragonSlayer", "凤炎刃", EquipmentSlot.WEAPON, 5, physicalAttack = 880, critChance = 0.10, description = "蕴含凤炎之力的绝世神兵，物理攻击力无双", price = 1036800),
        ...
        "phoenixWing" to EquipmentTemplate("phoenixWing", "阴阳扇", EquipmentSlot.WEAPON, 5, magicAttack = 880, critChance = 0.10, description = "蕴含阴阳之力的神扇，法术攻击力出众", price = 1036800),
        "celestialOrb" to EquipmentTemplate("celestialOrb", "天玄杖", EquipmentSlot.WEAPON, 5, magicAttack = 1280, critChance = 0.15, description = "蕴含天玄之力的神杖，攻击易暴击", price = 1036800),
        ...
        "chaosBlade" to EquipmentTemplate("chaosBlade", "玄玉刃", EquipmentSlot.WEAPON, 6, physicalAttack = 3980, critChance = 0.18, description = "玄玉淬炼的神刃，暴击率超凡入圣", price = 6000000),
        "primordialStaff" to EquipmentTemplate("primordialStaff", "天星杖", EquipmentSlot.WEAPON, 6, magicAttack = 2700, critChance = 0.13, description = "凝聚天星之力的法杖，法术攻击力无双", price = 6000000),
        "yinYangOrb" to EquipmentTemplate("yinYangOrb", "天玄扇", EquipmentSlot.WEAPON, 6, magicAttack = 3980, critChance = 0.18, description = "蕴含天玄道韵的至宝，攻击易暴击", price = 6000000)
    )

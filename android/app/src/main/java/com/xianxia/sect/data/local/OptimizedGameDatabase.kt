...
abstract class OptimizedGameDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        // KSP 1.x 已知 bug: 匿名 object 的 getSimpleName() 返回 null
        // 将 Migration 从匿名 object 改为具名 private class，KSP 访问时名称非 null
        // 详见: https://github.com/google/ksp/issues/2001
        ...
        /** 具名 Room Callback，避免使用匿名对象 */
        private class GameDatabaseCallback(private val slot: Int) : Callback() {
        ...
        // 使用具名类实例替代匿名对象
        internal val MIGRATION_53_54 = Migration53To54()
        internal val MIGRATION_54_55 = Migration54To55()
        internal val MIGRATION_55_56 = Migration55To56()
        internal val MIGRATION_56_57 = Migration56To57()
        internal val MIGRATION_57_58 = Migration57To58()
        ...
        fun create(context: Context, slot: Int): OptimizedGameDatabase {
            ...
            return Room.databaseBuilder(
                ...
                .addCallback(GameDatabaseCallback(slot))

...
object ItemDatabase {
    ...
    val battlePills: Map<String, PillTemplate> = mapOf(
        "commonPhysAtkPill" to PillTemplate("commonPhysAtkPill", "虎力丹", PillCategory.BATTLE, 1, "物理攻击+10%基础值，持续1场战斗", 3600, physicalAttackPercent = 0.10, battleCount = 1),
        "commonMagicAtkPill" to PillTemplate("commonMagicAtkPill", "灵火丹", PillCategory.BATTLE, 1, "法术攻击+10%基础值，持续1场战斗", 3600, magicAttackPercent = 0.10, battleCount = 1),
        "commonPhysDefPill" to PillTemplate("commonPhysDefPill", "铁甲丹", PillCategory.BATTLE, 1, "物理防御+10%基础值，持续1场战斗", 3600, physicalDefensePercent = 0.10, battleCount = 1),
        "commonMagicDefPill" to PillTemplate("commonMagicDefPill", "灵盾丹", PillCategory.BATTLE, 1, "法术防御+10%基础值，持续1场战斗", 3600, magicDefensePercent = 0.10, battleCount = 1),
        "commonHpPill" to PillTemplate("commonHpPill", "气血丹", PillCategory.BATTLE, 1, "生命值+10%基础值，持续1场战斗", 3600, hpPercent = 0.10, battleCount = 1),
        "commonMpPill" to PillTemplate("commonMpPill", "回灵丹", PillCategory.BATTLE, 1, "灵力容量+10%基础值，持续1场战斗", 3600, mpPercent = 0.10, battleCount = 1),
        "commonSpeedPill" to PillTemplate("commonSpeedPill", "疾风丹", PillCategory.BATTLE, 1, "速度+10%基础值，持续1场战斗", 3600, speedPercent = 0.10, battleCount = 1),
        ...
        "commonVitalityPill" to PillTemplate("commonVitalityPill", "生灵丹", PillCategory.BATTLE, 1, "生命值+8%，灵力容量+8%，持续1场战斗", 4320, hpPercent = 0.08, mpPercent = 0.08, battleCount = 1),

        "uncommonPhysAtkPill" to PillTemplate("uncommonPhysAtkPill", "熊力丹", PillCategory.BATTLE, 2, "物理攻击+15%基础值，持续1场战斗", 16200, physicalAttackPercent = 0.15, battleCount = 1),
        "uncommonMagicAtkPill" to PillTemplate("uncommonMagicAtkPill", "真火丹", PillCategory.BATTLE, 2, "法术攻击+15%基础值，持续1场战斗", 16200, magicAttackPercent = 0.15, battleCount = 1),
        "uncommonPhysDefPill" to PillTemplate("uncommonPhysDefPill", "铜墙丹", PillCategory.BATTLE, 2, "物理防御+15%基础值，持续1场战斗", 16200, physicalDefensePercent = 0.15, battleCount = 1),
        "uncommonMagicDefPill" to PillTemplate("uncommonMagicDefPill", "法盾丹", PillCategory.BATTLE, 2, "法术防御+15%基础值，持续1场战斗", 16200, magicDefensePercent = 0.15, battleCount = 1),
        "uncommonHpPill" to PillTemplate("uncommonHpPill", "血精丹", PillCategory.BATTLE, 2, "生命值+15%基础值，持续1场战斗", 16200, hpPercent = 0.15, battleCount = 1),
        "uncommonMpPill" to PillTemplate("uncommonMpPill", "汇灵丹", PillCategory.BATTLE, 2, "灵力容量+15%基础值，持续1场战斗", 16200, mpPercent = 0.15, battleCount = 1),
        "uncommonSpeedPill" to PillTemplate("uncommonSpeedPill", "迅风丹", PillCategory.BATTLE, 2, "速度+15%基础值，持续1场战斗", 16200, speedPercent = 0.15, battleCount = 1),
        ...
        "uncommonVitalityPill" to PillTemplate("uncommonVitalityPill", "命灵丹", PillCategory.BATTLE, 2, "生命值+12%，灵力容量+12%，持续1场战斗", 19440, hpPercent = 0.12, mpPercent = 0.12, battleCount = 1),

        "rarePhysAtkPill" to PillTemplate("rarePhysAtkPill", "龙力丹", PillCategory.BATTLE, 3, "物理攻击+20%基础值，持续1场战斗", 64800, physicalAttackPercent = 0.20, battleCount = 1),
        "rareMagicAtkPill" to PillTemplate("rareMagicAtkPill", "三昧丹", PillCategory.BATTLE, 3, "法术攻击+20%基础值，持续1场战斗", 64800, magicAttackPercent = 0.20, battleCount = 1),
        "rarePhysDefPill" to PillTemplate("rarePhysDefPill", "金刚丹", PillCategory.BATTLE, 3, "物理防御+20%基础值，持续1场战斗", 64800, physicalDefensePercent = 0.20, battleCount = 1),
        "rareMagicDefPill" to PillTemplate("rareMagicDefPill", "神盾丹", PillCategory.BATTLE, 3, "法术防御+20%基础值，持续1场战斗", 64800, magicDefensePercent = 0.20, battleCount = 1),
        "rareHpPill" to PillTemplate("rareHpPill", "血魂丹", PillCategory.BATTLE, 3, "生命值+20%基础值，持续1场战斗", 64800, hpPercent = 0.20, battleCount = 1),
        "rareMpPill" to PillTemplate("rareMpPill", "凝灵丹", PillCategory.BATTLE, 3, "灵力容量+20%基础值，持续1场战斗", 64800, mpPercent = 0.20, battleCount = 1),
        "rareSpeedPill" to PillTemplate("rareSpeedPill", "神风丹", PillCategory.BATTLE, 3, "速度+20%基础值，持续1场战斗", 64800, speedPercent = 0.20, battleCount = 1),
        ...
        "rareVitalityPill" to PillTemplate("rareVitalityPill", "元灵丹", PillCategory.BATTLE, 3, "生命值+16%，灵力容量+16%，持续1场战斗", 77760, hpPercent = 0.16, mpPercent = 0.16, battleCount = 1),

        "epicPhysAtkPill" to PillTemplate("epicPhysAtkPill", "神力丹", PillCategory.BATTLE, 4, "物理攻击+25%基础值，持续1场战斗", 259200, physicalAttackPercent = 0.25, battleCount = 1),
        "epicMagicAtkPill" to PillTemplate("epicMagicAtkPill", "玄火丹", PillCategory.BATTLE, 4, "法术攻击+25%基础值，持续1场战斗", 259200, magicAttackPercent = 0.25, battleCount = 1),
        "epicPhysDefPill" to PillTemplate("epicPhysDefPill", "玄盾丹", PillCategory.BATTLE, 4, "物理防御+25%基础值，持续1场战斗", 259200, physicalDefensePercent = 0.25, battleCount = 1),
        "epicMagicDefPill" to PillTemplate("epicMagicDefPill", "玄罡丹", PillCategory.BATTLE, 4, "法术防御+25%基础值，持续1场战斗", 259200, magicDefensePercent = 0.25, battleCount = 1),
        "epicHpPill" to PillTemplate("epicHpPill", "玄血丹", PillCategory.BATTLE, 4, "生命值+25%基础值，持续1场战斗", 259200, hpPercent = 0.25, battleCount = 1),
        "epicMpPill" to PillTemplate("epicMpPill", "玄灵丹", PillCategory.BATTLE, 4, "灵力容量+25%基础值，持续1场战斗", 259200, mpPercent = 0.25, battleCount = 1),
        "epicSpeedPill" to PillTemplate("epicSpeedPill", "玄风丹", PillCategory.BATTLE, 4, "速度+25%基础值，持续1场战斗", 259200, speedPercent = 0.25, battleCount = 1),
        ...
        "epicVitalityPill" to PillTemplate("epicVitalityPill", "真灵丹", PillCategory.BATTLE, 4, "生命值+20%，灵力容量+20%，持续1场战斗", 311040, hpPercent = 0.20, mpPercent = 0.20, battleCount = 1),

        "legendaryPhysAtkPill" to PillTemplate("legendaryPhysAtkPill", "霸力丹", PillCategory.BATTLE, 5, "物理攻击+30%基础值，持续1场战斗", 1036800, physicalAttackPercent = 0.30, battleCount = 1),
        "legendaryMagicAtkPill" to PillTemplate("legendaryMagicAtkPill", "地火丹", PillCategory.BATTLE, 5, "法术攻击+30%基础值，持续1场战斗", 1036800, magicAttackPercent = 0.30, battleCount = 1),
        "legendaryPhysDefPill" to PillTemplate("legendaryPhysDefPill", "地罡丹", PillCategory.BATTLE, 5, "物理防御+30%基础值，持续1场战斗", 1036800, physicalDefensePercent = 0.30, battleCount = 1),
        "legendaryMagicDefPill" to PillTemplate("legendaryMagicDefPill", "地护丹", PillCategory.BATTLE, 5, "法术防御+30%基础值，持续1场战斗", 1036800, magicDefensePercent = 0.30, battleCount = 1),
        "legendaryHpPill" to PillTemplate("legendaryHpPill", "地血丹", PillCategory.BATTLE, 5, "生命值+30%基础值，持续1场战斗", 1036800, hpPercent = 0.30, battleCount = 1),
        "legendaryMpPill" to PillTemplate("legendaryMpPill", "地灵丹", PillCategory.BATTLE, 5, "灵力容量+30%基础值，持续1场战斗", 1036800, mpPercent = 0.30, battleCount = 1),
        "legendarySpeedPill" to PillTemplate("legendarySpeedPill", "地风丹", PillCategory.BATTLE, 5, "速度+30%基础值，持续1场战斗", 1036800, speedPercent = 0.30, battleCount = 1),
        ...
        "legendaryVitalityPill" to PillTemplate("legendaryVitalityPill", "混灵丹", PillCategory.BATTLE, 5, "生命值+24%，灵力容量+24%，持续1场战斗", 1244160, hpPercent = 0.24, mpPercent = 0.24, battleCount = 1),

        "mythicPhysAtkPill" to PillTemplate("mythicPhysAtkPill", "天力丹", PillCategory.BATTLE, 6, "物理攻击+40%基础值，持续1场战斗", 4147200, physicalAttackPercent = 0.40, battleCount = 1),
        "mythicMagicAtkPill" to PillTemplate("mythicMagicAtkPill", "天火丹", PillCategory.BATTLE, 6, "法术攻击+40%基础值，持续1场战斗", 4147200, magicAttackPercent = 0.40, battleCount = 1),
        "mythicPhysDefPill" to PillTemplate("mythicPhysDefPill", "天罡丹", PillCategory.BATTLE, 6, "物理防御+40%基础值，持续1场战斗", 4147200, physicalDefensePercent = 0.40, battleCount = 1),
        "mythicMagicDefPill" to PillTemplate("mythicMagicDefPill", "天护丹", PillCategory.BATTLE, 6, "法术防御+40%基础值，持续1场战斗", 4147200, magicDefensePercent = 0.40, battleCount = 1),
        "mythicHpPill" to PillTemplate("mythicHpPill", "天血丹", PillCategory.BATTLE, 6, "生命值+40%基础值，持续1场战斗", 4147200, hpPercent = 0.40, battleCount = 1),
        "mythicMpPill" to PillTemplate("mythicMpPill", "天灵丹", PillCategory.BATTLE, 6, "灵力容量+40%基础值，持续1场战斗", 4147200, mpPercent = 0.40, battleCount = 1),
        "mythicSpeedPill" to PillTemplate("mythicSpeedPill", "天风丹", PillCategory.BATTLE, 6, "速度+40%基础值，持续1场战斗", 4147200, speedPercent = 0.40, battleCount = 1),
        ...
        "mythicVitalityPill" to PillTemplate("mythicVitalityPill", "圣灵丹", PillCategory.BATTLE, 6, "生命值+32%，灵力容量+32%，持续1场战斗", 4976640, hpPercent = 0.32, mpPercent = 0.32, battleCount = 1)
    )

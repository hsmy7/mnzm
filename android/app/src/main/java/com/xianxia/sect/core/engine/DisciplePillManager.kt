...
object DisciplePillManager {
    ...
    fun pillToItemEffect(pill: Pill): ItemEffect {
        return ItemEffect(
            cultivationSpeedPercent = pill.cultivationSpeedPercent,
            skillExpSpeedPercent = pill.skillExpSpeedPercent,
            nurtureSpeedPercent = pill.nurtureSpeedPercent,
            breakthroughChance = pill.breakthroughChance,
            targetRealm = pill.targetRealm,
            cultivationAdd = pill.cultivationAdd,
            skillExpAdd = pill.skillExpAdd,
            nurtureAdd = pill.nurtureAdd,
            healMaxHpPercent = pill.healMaxHpPercent,
            mpRecoverMaxMpPercent = pill.mpRecoverMaxMpPercent,
            hpAdd = pill.hpAdd,
            mpAdd = pill.mpAdd,
            extendLife = pill.extendLife,
            physicalAttackAdd = pill.physicalAttackAdd,
            magicAttackAdd = pill.magicAttackAdd,
            physicalDefenseAdd = pill.physicalDefenseAdd,
            magicDefenseAdd = pill.magicDefenseAdd,
            speedAdd = pill.speedAdd,
            critRateAdd = pill.critRateAdd,
            critEffectAdd = pill.critEffectAdd,
            intelligenceAdd = pill.intelligenceAdd,
            charmAdd = pill.charmAdd,
            loyaltyAdd = pill.loyaltyAdd,
            comprehensionAdd = pill.comprehensionAdd,
            artifactRefiningAdd = pill.artifactRefiningAdd,
            pillRefiningAdd = pill.pillRefiningAdd,
            spiritPlantingAdd = pill.spiritPlantingAdd,
            teachingAdd = pill.teachingAdd,
            moralityAdd = pill.moralityAdd,
            revive = pill.revive,
            clearAll = pill.clearAll,
            isAscension = pill.isAscension,
            duration = pill.duration,
            cannotStack = pill.cannotStack,

...
object HerbDatabase {
    ...
    private val tier1Herbs = listOf(
        ...
        Herb("spiritGrass2", "清心草", 1, 1, "grass", "叶片清凉，可清心明目，安神定志"),
        Herb("spiritGrass3", "凝气草", 1, 1, "grass", "凝聚灵气的灵草，辅助修炼佳品"),
        Herb("spiritFlower1", "云雾花", 1, 1, "flower", "生于云雾间的灵花，清热解毒"),
        Herb("spiritFlower2", "白莲", 1, 1, "flower", "洁白无瑕的莲花，清心降火"),
        Herb("spiritFlower3", "晨露花", 1, 1, "flower", "清晨露水滋养的灵花，润肺生津"),
        Herb("spiritFruit1", "精气果", 1, 1, "fruit", "蕴含精气的灵果，明目养肾"),
        Herb("spiritFruit2", "赤心果", 1, 1, "fruit", "形似红心的灵果，补气养血"),
        Herb("spiritFruit3", "灵韵果", 1, 1, "fruit", "蕴含灵韵的灵果，滋养经脉")
    )
    
    private val tier2Herbs = listOf(
        Herb("spiritGrass4", "寒霜草", 2, 2, "grass", "冰寒之地生长的灵草，蕴含寒气"),
        Herb("spiritGrass5", "烈焰草", 2, 2, "grass", "火山附近生长的灵草，蕴含火力"),
        Herb("spiritGrass6", "金灵草", 2, 2, "grass", "吸收金精之气而生，泻火解毒"),
        Herb("spiritFlower4", "冰魄莲", 2, 2, "flower", "生于极寒之地的冰属性灵花，花瓣如冰晶"),
        Herb("spiritFlower5", "双生花", 2, 2, "flower", "金银双色并蒂而生，可解百毒"),
        Herb("spiritFlower6", "紫霄花", 2, 2, "flower", "紫气缭绕的灵花，安神定魄"),
        Herb("spiritFruit4", "通灵果", 2, 2, "fruit", "可通经脉的灵果，消肿散结"),
        Herb("spiritFruit5", "玄灵果", 2, 2, "fruit", "色如墨玉的灵果，滋补肝肾"),
        Herb("spiritFruit6", "五行果", 2, 2, "fruit", "蕴含五行之气的奇果，调和阴阳")
    )
    
    private val tier3Herbs = listOf(
        Herb("spiritGrass7", "龙血草", 3, 3, "grass", "沾染真龙之血而生的灵草，蕴含龙威"),
        Herb("spiritGrass8", "风铃草", 3, 3, "grass", "随风摇曳的灵草，祛风除湿"),
        Herb("spiritGrass9", "九转灵草", 3, 3, "grass", "九转轮回方可成熟的灵草，蕴含轮回之力"),
        Herb("spiritFlower7", "九转仙兰", 3, 3, "flower", "九转轮回方可盛开的仙界灵花"),
        Herb("spiritFlower8", "凤凰花", 3, 3, "flower", "凤凰栖息之地生长的灵花，蕴含涅槃之力"),
        Herb("spiritFlower9", "青龙花", 3, 3, "flower", "龙气滋养的灵花，强筋健骨"),
        Herb("spiritFruit7", "赤阳果", 3, 3, "fruit", "吸收日精月华而生的赤红灵果"),
        Herb("spiritFruit8", "玄灵莓", 3, 3, "fruit", "色如墨玉的灵果，滋补肝肾"),
        Herb("spiritFruit9", "天元果", 3, 3, "fruit", "天元之力凝结的灵果，补气固本")
    )
    
    private val tier4Herbs = listOf(
        Herb("spiritGrass10", "玄冰草", 4, 4, "grass", "万年玄冰中孕育的冰魄精华"),
        Herb("spiritGrass11", "风暴草", 4, 4, "grass", "飓风区域生长的灵草，化风定惊"),
        Herb("spiritGrass12", "神命草", 4, 4, "grass", "神山之巅的灵草，起死回生"),
        Herb("spiritFlower10", "日月同辉花", 4, 4, "flower", "日月同辉之时方可绽放的神花"),
        Herb("spiritFlower11", "紫云花", 4, 4, "flower", "生于紫云深处的灵花，补气安神"),
        Herb("spiritFlower12", "玄武花", 4, 4, "flower", "玄武守护之地生长的灵花，蕴含大地之力"),
        Herb("spiritFruit10", "长生果", 4, 4, "fruit", "三千年一开花，三千年一结果的仙果"),
        Herb("spiritFruit11", "仙灵果", 4, 4, "fruit", "仙界遗落的灵果，蕴含仙气"),
        Herb("spiritFruit12", "天灵果", 4, 4, "fruit", "吸收天界灵气而生的神果")
    )
    
    private val tier5Herbs = listOf(
        Herb("spiritGrass13", "仙灵草", 5, 5, "grass", "仙界遗落的灵草，蕴含仙气"),
        Herb("spiritGrass14", "天灵草", 5, 5, "grass", "吸收天界灵气而生的神草"),
        Herb("spiritGrass15", "混沌草", 5, 5, "grass", "混沌初开时诞生的神草，蕴含混沌本源之力"),
        Herb("spiritFlower13", "涅槃凤仙花", 5, 5, "flower", "凤凰涅槃之地孕育的仙花，花瓣如凤羽般绚烂"),
        Herb("spiritFlower14", "龙鳞仙莲", 5, 5, "flower", "真龙栖息之池生长的仙莲，莲瓣如龙鳞般坚韧"),
        Herb("spiritFlower15", "白虎幽兰", 5, 5, "flower", "白虎栖息之谷生长的幽兰，花香蕴含杀伐之气"),
        Herb("spiritFruit13", "九叶还魂果", 5, 5, "fruit", "九叶齐生，有还魂续命之效的仙果"),
        Herb("spiritFruit14", "玄天灵果", 5, 5, "fruit", "玄天之上孕育的灵果，通体玄光流转"),
        Herb("spiritFruit15", "星陨神果", 5, 5, "fruit", "星辰陨落后凝结的神果，蕴含星力")
    )
    
    private val tier6Herbs = listOf(
        Herb("spiritGrass16", "鸿蒙草", 6, 6, "grass", "鸿蒙初开时诞生的神草，蕴含鸿蒙本源"),
        Herb("spiritGrass17", "太初草", 6, 6, "grass", "太古时期诞生的神草，蕴含太初之力"),
        Herb("spiritGrass18", "永恒草", 6, 6, "grass", "永恒不灭的神草，时间法则的化身"),
        Herb("spiritFlower16", "永恒花", 6, 6, "flower", "永恒不谢的仙花，时间法则的化身"),
        Herb("spiritFlower17", "混沌仙莲", 6, 6, "flower", "混沌中诞生的仙莲，蕴含混沌本源"),
        Herb("spiritFlower18", "造化神花", 6, 6, "flower", "天地造化孕育的神花，蕴含造化之力"),
        Herb("spiritFruit16", "瑞麟仙果", 6, 6, "fruit", "瑞兽麒麟守护万年的仙果，已生灵智"),
        Herb("spiritFruit17", "玄武帝果", 6, 6, "fruit", "玄武守护之地生长的天品灵果，蕴含大地精华"),
        Herb("spiritFruit18", "混沌神果", 6, 6, "fruit", "混沌初开时诞生的神果，蕴含混沌本源")
    )

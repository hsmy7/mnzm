...
data class SerializableGameData(
    ...
    @ProtoNumber(21) val tradingSellList: List<SerializableTradingItem> = emptyList(),
    @ProtoNumber(22) val tradingBuyList: List<SerializableTradingItem> = emptyList(),
    @ProtoNumber(23) val tradeLogs: List<SerializableTradeLog> = emptyList(),
    ...
    @ProtoNumber(51) val lastMissionRefreshYear: Int = 0
)
...
@Serializable
data class SerializableTradingItem(
    @ProtoNumber(1) val id: String,
...
@Serializable
data class SerializableTradeLog(
    @ProtoNumber(1) val id: String,
    @ProtoNumber(2) val timestamp: Long,
    @ProtoNumber(3) val type: String,
    @ProtoNumber(4) val itemId: String,
    @ProtoNumber(5) val itemName: String,
    @ProtoNumber(6) val itemType: String,
    @ProtoNumber(7) val quantity: Int,
    @ProtoNumber(8) val price: Int,
    @ProtoNumber(9) val totalPrice: Int,
    @ProtoNumber(10) val spiritStonesBefore: Long,
    @ProtoNumber(11) val spiritStonesAfter: Long
)
...
data class SerializableElderSlots(
    ...
    @ProtoNumber(5) val libraryElder: String? = null,
    ...
    @ProtoNumber(18) val libraryDisciples: List<SerializableDirectDiscipleSlot> = emptyList(),
...
data class SerializableLibrarySlot(
    ...
    @ProtoNumber(2) val discipleId: String? = null,
    @ProtoNumber(3) val discipleName: String,
    @ProtoNumber(4) val efficiency: Double
)

...
inline const std::vector<RealmConfig>& realmConfigs() {
    static const std::vector<RealmConfig> kConfigs = {
        ...
        {8, "筑基", 1950, 30, 120, 9, 507, 195, 39, 39, 33, 26, 38},
        {7, "金丹", 7800, 50, 200, 9, 1318, 507, 101, 101, 85, 68, 98},
        {6, "元婴", 29250, 80, 300, 9, 3448, 1326, 265, 265, 221, 177, 255},
        {5, "化神", 97500, 110, 500, 9, 9126, 3510, 702, 702, 585, 468, 675},
        {4, "炼虚", 292500, 180, 800, 9, 22308, 8580, 1716, 1716, 1430, 1144, 1650},
        {3, "合体", 975000, 220, 1500, 9, 52728, 20280, 4056, 4056, 3380, 2704, 3900},
        {2, "大乘", 2925000, 280, 2500, 9, 117624, 45240, 9048, 9048, 7540, 6032, 8700},
        {1, "渡劫", 9750000, 360, 4000, 9, 243360, 93600, 18720, 18720, 15600, 12480, 18000},

...
fun BuildingFeatureRegistry.registerDefaults() {
    listOf(
        ...
        BuildingFeature("alchemy", "炼丹炉", BuildingType.ALCHEMY,
            ...
            cost = 4000, gridWidth = 4, gridHeight = 3, spriteWidth = 4, spriteHeight = 4,
        ...
        BuildingFeature("forge", "锻造坊", BuildingType.FORGE,
            ...
            cost = 4000, gridWidth = 5, gridHeight = 3, spriteWidth = 5, spriteHeight = 6,
        ...
        BuildingFeature("warehouse", "仓库", BuildingType.WAREHOUSE,
            ...
            cost = 1500, gridWidth = 6, gridHeight = 5, spriteWidth = 6, spriteHeight = 6,
        ...
        BuildingFeature("mission_hall", "任务阁", BuildingType.MISSION_HALL,
            ...
            cost = 6000, gridWidth = 4, gridHeight = 3, spriteWidth = 4, spriteHeight = 6,
        ...
        BuildingFeature("reflection_cliff", "监牢", BuildingType.REFLECTION_CLIFF,
            ...
            cost = 5000, gridWidth = 4, gridHeight = 4, description = "悔过自新之地，关押违规弟子"),
        BuildingFeature("single_residence", "单人住所", BuildingType.SINGLE_RESIDENCE,
            ...
            cost = 12000, gridWidth = 4, gridHeight = 4, description = "为弟子提供清修之所，修炼速度+20%，可升级",
        ...
        BuildingFeature("multi_residence", "多人住所", BuildingType.MULTI_RESIDENCE,
            ...
            cost = 24000, gridWidth = 6, gridHeight = 4, spriteWidth = 6, spriteHeight = 4,

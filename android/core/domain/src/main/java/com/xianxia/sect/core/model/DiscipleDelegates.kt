...
var Disciple.totalCultivation: kotlin.Long get() = combat.totalCultivation; set(value) { combat
    .totalCultivation = value }
/** @deprecated 请改用 [combat.breakthroughCount] */
var Disciple.breakthroughCount: kotlin.Int get() = combat.breakthroughCount; set(value) { combat
    .breakthroughCount = value }
/** @deprecated 请改用 [combat.breakthroughFailCount] */
var Disciple.breakthroughFailCount: kotlin.Int get() = combat.breakthroughFailCount; set(value) { combat
    .breakthroughFailCount = value }
...
var Disciple.pillSpeedBonus: kotlin.Int get() = pillEffects.pillSpeedBonus; set(value) { pillEffects
    .pillSpeedBonus = value }
/** @deprecated 请改用 [pillEffects.pillEffectDuration] */
var Disciple.pillEffectDuration: kotlin.Int get() = pillEffects.pillEffectDuration; set(value) { pillEffects
    .pillEffectDuration = value }
/** @deprecated 请改用 [pillEffects.pillCritRateBonus] */
var Disciple.pillCritRateBonus: kotlin.Double get() = pillEffects.pillCritRateBonus; set(value) { pillEffects
    .pillCritRateBonus = value }
/** @deprecated 请改用 [pillEffects.pillCritEffectBonus] */
var Disciple.pillCritEffectBonus: kotlin.Double get() = pillEffects.pillCritEffectBonus; set(value) { pillEffects
    .pillCritEffectBonus = value }
/** @deprecated 请改用 [pillEffects.pillCultivationSpeedBonus] */
var Disciple.pillCultivationSpeedBonus: kotlin.Double get() = pillEffects
    .pillCultivationSpeedBonus; set(value) { pillEffects.pillCultivationSpeedBonus = value }
...
var Disciple.storageBagSpiritStones: kotlin.Long get() = equipment.storageBagSpiritStones; set(value) { equipment
    .storageBagSpiritStones = value }
...
var Disciple.artifactRefining: kotlin.Int get() = skills.artifactRefining; set(value) { skills
    .artifactRefining = value }
...
var Disciple.salaryMissedCount: kotlin.Int get() = skills.salaryMissedCount; set(value) { skills
    .salaryMissedCount = value }
...
var Disciple.hasClearAllEffect: kotlin.Boolean get() = usage.hasClearAllEffect; set(value) { usage
    .hasClearAllEffect = value }

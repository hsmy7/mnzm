...
class EquipmentRegistry : BaseTemplateRegistry<EquipmentDatabase.EquipmentTemplate>() {
    ...
    val weapons: Map<String, EquipmentDatabase.EquipmentTemplate> = mapOf(
        ...
        "crystalOrb" to EquipmentDatabase.EquipmentTemplate("crystalOrb", "碧木扇", EquipmentSlot.WEAPON, 1, magicAttack = 14, critChance = 0.04, description = "碧木炼制的灵扇，蕴含微量灵气，易触发暴击", price = 3600),
        ...
        "battleAxe" to EquipmentDatabase.EquipmentTemplate("battleAxe", "凌华刀", EquipmentSlot.WEAPON, 2, physicalAttack = 44, critChance = 0.06, description = "刀光凌厉如华，威力巨大且易暴击", price = 16200),
        ...
        // 宝品 (rarity: 3)
        "frostBlade" to EquipmentDatabase.EquipmentTemplate("frostBlade", "青碧刃", EquipmentSlot.WEAPON, 3, physicalAttack = 92, critChance = 0.06, description = "蕴含青碧灵力的宝刀，物理攻击力出众", price = 64800),
        ...
        "frostOrb" to EquipmentDatabase.EquipmentTemplate("frostOrb", "玄冰扇", EquipmentSlot.WEAPON, 3, magicAttack = 136, critChance = 0.09, description = "蕴含玄冰之力的宝扇，攻击易暴击", price = 64800),
        ...
        "voidStaff" to EquipmentDatabase.EquipmentTemplate("voidStaff", "虚华杖", EquipmentSlot.WEAPON, 4, magicAttack = 285, critChance = 0.08, description = "虚华流转的玄妙法杖，法术攻击力出众", price = 259200),
        "phoenixFan" to EquipmentDatabase.EquipmentTemplate("phoenixFan", "凰焰扇", EquipmentSlot.WEAPON, 4, magicAttack = 420, critChance = 0.12, description = "凰焰淬炼的神扇，攻击易暴击", price = 259200),

        // 地品 (rarity: 5)
        "dragonSlayer" to EquipmentDatabase.EquipmentTemplate("dragonSlayer", "凤炎刃", EquipmentSlot.WEAPON, 5, physicalAttack = 880, critChance = 0.10, description = "蕴含凤炎之力的绝世神兵，物理攻击力无双", price = 1036800),
        ...
        "phoenixWing" to EquipmentDatabase.EquipmentTemplate("phoenixWing", "阴阳扇", EquipmentSlot.WEAPON, 5, magicAttack = 880, critChance = 0.10, description = "蕴含阴阳之力的神扇，法术攻击力出众", price = 1036800),
        "celestialOrb" to EquipmentDatabase.EquipmentTemplate("celestialOrb", "天玄杖", EquipmentSlot.WEAPON, 5, magicAttack = 1280, critChance = 0.15, description = "蕴含天玄之力的神杖，攻击易暴击", price = 1036800),
        ...
        "chaosBlade" to EquipmentDatabase.EquipmentTemplate("chaosBlade", "玄玉刃", EquipmentSlot.WEAPON, 6, physicalAttack = 3980, critChance = 0.18, description = "玄玉淬炼的神刃，暴击率超凡入圣", price = 6000000),
        "primordialStaff" to EquipmentDatabase.EquipmentTemplate("primordialStaff", "天星杖", EquipmentSlot.WEAPON, 6, magicAttack = 2700, critChance = 0.13, description = "凝聚天星之力的法杖，法术攻击力无双", price = 6000000),
        "yinYangOrb" to EquipmentDatabase.EquipmentTemplate("yinYangOrb", "天玄扇", EquipmentSlot.WEAPON, 6, magicAttack = 3980, critChance = 0.18, description = "蕴含天玄道韵的至宝，攻击易暴击", price = 6000000)
    )
    ...
    val armors: Map<String, EquipmentDatabase.EquipmentTemplate> = mapOf(
        ...
        "bronzePlate" to EquipmentDatabase.EquipmentTemplate("bronzePlate", "精铁甲", EquipmentSlot.ARMOR, 1, magicDefense = 7, hp = 84, description = "精铁铸造的铠甲，坚固且增强生命", price = 3600),
        "clothRobe" to EquipmentDatabase.EquipmentTemplate("clothRobe", "灵竹衣", EquipmentSlot.ARMOR, 1, magicDefense = 11, hp = 126, description = "灵竹纤维制成的衣物，法术防御出众", price = 3600),

        // 灵品 (rarity: 2)
        "ironPlate" to EquipmentDatabase.EquipmentTemplate("ironPlate", "碧叶甲", EquipmentSlot.ARMOR, 2, physicalDefense = 22, hp = 264, description = "碧玉叶片打造的护甲，物理防御力强大", price = 16200),
        "steelArmor" to EquipmentDatabase.EquipmentTemplate("steelArmor", "丹羽衣", EquipmentSlot.ARMOR, 2, physicalDefense = 34, hp = 396, description = "丹砂羽线织成的法衣，增强生命力", price = 16200),
        ...
        // 宝品 (rarity: 3)
        "scaleArmor" to EquipmentDatabase.EquipmentTemplate("scaleArmor", "青鳞铠", EquipmentSlot.ARMOR, 3, physicalDefense = 68, hp = 846, description = "妖兽青鳞打造的铠甲，物理防御力惊人", price = 64800),
        "plateArmor" to EquipmentDatabase.EquipmentTemplate("plateArmor", "银板铠", EquipmentSlot.ARMOR, 3, physicalDefense = 102, hp = 1270, description = "整块银钢锻造的铠甲，增强生命力", price = 64800),
        "mysticRobe" to EquipmentDatabase.EquipmentTemplate("mysticRobe", "汐流衣", EquipmentSlot.ARMOR, 3, magicDefense = 68, hp = 846, description = "蕴含汐流之力的法衣，法术防御出众", price = 64800),
        ...
        // 玄品 (rarity: 4)
        "dragonScale" to EquipmentDatabase.EquipmentTemplate("dragonScale", "龙鳞铠", EquipmentSlot.ARMOR, 4, physicalDefense = 210, hp = 2688, description = "真龙鳞片锻造的铠甲，物理防御无双", price = 259200),
        "titanArmor" to EquipmentDatabase.EquipmentTemplate("titanArmor", "渊岩铠", EquipmentSlot.ARMOR, 4, physicalDefense = 315, hp = 4032, description = "深渊岩铁铸造的铠甲，增强生命力", price = 259200),
        "voidRobe" to EquipmentDatabase.EquipmentTemplate("voidRobe", "瑶光袍", EquipmentSlot.ARMOR, 4, magicDefense = 210, hp = 2688, description = "蕴含瑶光之力的法袍，法术防御出众", price = 259200),
        ...
        // 地品 (rarity: 5)
        "earthArmor" to EquipmentDatabase.EquipmentTemplate("earthArmor", "玄幽袍", EquipmentSlot.ARMOR, 5, physicalDefense = 650, hp = 8500, description = "承载玄幽之力的法袍，物理防御如幽渊般坚固", price = 1036800),
        "divinePlate" to EquipmentDatabase.EquipmentTemplate("divinePlate", "墨幽铠", EquipmentSlot.ARMOR, 5, physicalDefense = 978, hp = 12760, description = "墨幽玄铁铸造的铠甲，增强生命力", price = 1036800),
        "celestialRobe" to EquipmentDatabase.EquipmentTemplate("celestialRobe", "凌星袍", EquipmentSlot.ARMOR, 5, magicDefense = 650, hp = 8500, description = "凌驾星辰之力的法袍，法术防御超凡入圣", price = 1036800),
        "voidShadowRobe" to EquipmentDatabase.EquipmentTemplate("voidShadowRobe", "定海铠", EquipmentSlot.ARMOR, 5, magicDefense = 978, hp = 12760, description = "定海之力凝聚的铠甲，增强生命力", price = 1036800),
        ...
        "primordialArmor" to EquipmentDatabase.EquipmentTemplate("primordialArmor", "苍罡铠", EquipmentSlot.ARMOR, 6, physicalDefense = 3000, hp = 39400, description = "苍罡之力凝聚的神甲，承载创世生命之力", price = 6000000),
        "immortalRobe" to EquipmentDatabase.EquipmentTemplate("immortalRobe", "曦光铠", EquipmentSlot.ARMOR, 6, magicDefense = 2000, hp = 26200, description = "蕴含曦光之力的铠甲，法术防御超凡入圣", price = 6000000),
        "chaosRobe" to EquipmentDatabase.EquipmentTemplate("chaosRobe", "云影袍", EquipmentSlot.ARMOR, 6, magicDefense = 3000, hp = 39400, description = "云影交织的法袍，蕴含无尽生命之力", price = 6000000)
    )

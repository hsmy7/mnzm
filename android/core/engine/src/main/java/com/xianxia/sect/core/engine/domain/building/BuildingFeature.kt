...
sealed interface SlotGroup {
        ...
        override fun createSlots(instanceId: String, existingData: GameData, activeId: String, feature: BuildingFeature,
            ...
            SlotCreationResult(
                spiritMineSlots = (0 until slotsPerInstance).map { offset ->
                    SpiritMineSlot(index = existingData.spiritMineSlots.size + offset, buildingInstanceId = instanceId,
                        sectId = activeId)
                }
            )
    }
    ...
    data class ProductionSlotGroup(override val slotsPerInstance: Int = 1) : SlotGroup {
        ...
        override fun collectDiscipleIds(data: GameData, instanceId: String, feature: BuildingFeature?): Set<String> {
            ...
            return data.productionSlots
                .filter { it.buildingInstanceId == instanceId && it.buildingId == buildingId && !it.assignedDiscipleId
                    .isNullOrEmpty() }
    ...
    data class SpiritField(override val slotsPerInstance: Int = 1) : SlotGroup {
        ...
        override fun collectDiscipleIds(data: GameData, instanceId: String,
            feature: BuildingFeature?) = emptySet<String>()

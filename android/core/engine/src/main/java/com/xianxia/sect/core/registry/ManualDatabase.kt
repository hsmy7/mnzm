...
object ManualDatabase {
            ...
            synchronized(initLock) {
                ...
                if (enableProtoValidation && _allManuals != null) {
                    ...
                    if (!result.isValid) {
                        ...
                        DomainLog.i(TAG, "Manual data validation passed: ${manuals.size} templates verified")
                    }
                }
    ...
    private fun protoToManualTemplate(proto: ManualTemplateProto): ManualTemplate {
        ...
        if (proto.hasSkill()) {
            ...
            template = template.copy(
                ...
                skillHealFixed = skill.healFixed,
                ...
                skillBuffs = buffs,
                skillShieldPercent = skill.shieldPercent,
                skillTurnAdvancePercent = skill.turnAdvancePercent,
                skillDamageSharePercent = skill.damageSharePercent,
                skillDamageLinkPercent = skill.damageLinkPercent
            )
        }
    ...
    private data class ManualJsonDataSync(
        ...
        val skillShieldPercent: Double? = null,
        val skillTurnAdvancePercent: Double? = null,
    ...
    fun createFromTemplate(template: ManualTemplate): ManualStack {
        ...
        return ManualStack(
            ...
            skillHealFixed = template.skillHealFixed,
            ...
            skillShieldPercent = template.skillShieldPercent,
            skillTurnAdvancePercent = template.skillTurnAdvancePercent,
            skillDamageSharePercent = template.skillDamageSharePercent,
            skillDamageLinkPercent = template.skillDamageLinkPercent,

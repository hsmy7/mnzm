...
object MissionSystem {
    ...
    /** 低阶任务奖励配置（createRewardConfig 拆分） */
    private fun createTier1RewardConfig(template: MissionTemplate): MissionRewardConfig? = when (template) {
    ...
    /** 中阶任务奖励配置（createRewardConfig 拆分） */
    private fun createTier2RewardConfig(template: MissionTemplate): MissionRewardConfig? = when (template) {
    ...
    /** 高阶任务奖励配置（createRewardConfig 拆分） */
    private fun createTier3RewardConfig(template: MissionTemplate): MissionRewardConfig? = when (template) {
    ...
    /** 顶阶任务奖励配置（createRewardConfig 拆分） */
    private fun createTier4RewardConfig(template: MissionTemplate): MissionRewardConfig? = when (template) {

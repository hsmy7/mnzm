...
class SaveService @Inject constructor(
    ...
    fun getStateSnapshotSync(): GameStateSnapshot {
        ...
        return GameStateSnapshot(
            ...
            forgeSlotCount = productionSlotRepository.getSlotsByType(com.xianxia.sect.core.model.production.BuildingType
                .FORGE).count { it.isWorking },
            alchemySlotCount = productionSlotRepository.getSlotsByType(com.xianxia.sect.core.model.production
                .BuildingType.ALCHEMY).count { it.isWorking },
    ...
    fun getStateStatistics(): Map<String, Any> {
        ...
        return mapOf(
            ...
            "activeForgingSlots" to productionSlotRepository.getSlotsByType(com.xianxia.sect.core.model.production
                .BuildingType.FORGE).count { it.isWorking },
            "activeAlchemySlots" to productionSlotRepository.getSlotsByType(com.xianxia.sect.core.model.production
                .BuildingType.ALCHEMY).count { it.isWorking },

...
class CultivationServiceIntegrationTest {
    ...
    fun setUp() {
        ...
        DiscipleAggregate.statsProvider = object : DiscipleStatsProvider {
            ...
            override fun calculateCultivationSpeed(d: Disciple, manuals: Map<String, ManualInstance>, mps: Map<String, ManualProficiencyData>, bb: Double, ab: Double, peb: Double, pmb: Double, csb: Double, pcb: Double, gcp: Double, mdb: Double) = DiscipleStatCalculator.calculateCultivationSpeed(d, manuals, mps, bb, ab, peb, pmb, csb, pcb, gcp, mdb)
            override fun calculateCultivationSpeed(a: DiscipleAggregate, manuals: Map<String, ManualInstance>, mps: Map<String, ManualProficiencyData>, bb: Double, ab: Double, peb: Double, pmb: Double, csb: Double, pcb: Double, gcp: Double, mdb: Double) = DiscipleStatCalculator.calculateCultivationSpeed(a, manuals, mps, bb, ab, peb, pmb, csb, pcb, gcp, mdb)

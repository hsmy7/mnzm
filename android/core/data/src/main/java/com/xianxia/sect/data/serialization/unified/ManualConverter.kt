...
class ManualConverter {
    ...
    fun convertManual(instance: ManualInstance): SerializableManual {
        return SerializableManual(
            ...
            skillDamageType = instance.skillDamageType,
            skillHits = instance.skillHits,
            skillDamageMultiplier = instance.skillDamageMultiplier,
            skillCooldown = instance.skillCooldown,
            skillMpCost = instance.skillMpCost,
            skillHealPercent = instance.skillHealPercent,
            skillHealFixed = instance.skillHealFixed,
            skillHealType = instance.skillHealType,
            skillBuffType = instance.skillBuffType ?: "",
            skillBuffValue = instance.skillBuffValue,
            skillBuffDuration = instance.skillBuffDuration,
            skillBuffsJson = instance.skillBuffsJson,
            skillIsAoe = instance.skillIsAoe,
            skillTargetScope = instance.skillTargetScope,
            skillShieldPercent = instance.skillShieldPercent,
            skillTurnAdvancePercent = instance.skillTurnAdvancePercent,
            skillDamageSharePercent = instance.skillDamageSharePercent,
            skillDamageLinkPercent = instance.skillDamageLinkPercent,
    ...
    fun convertBackManual(data: SerializableManual): ManualInstance {
        return ManualInstance(
            ...
            rarity = data.rarity,
            stats = data.stats,
            skillName = data.skillName.ifEmpty { null },
            skillDescription = data.skillDescription.ifEmpty { null },
            skillType = data.skillType,
            skillDamageType = data.skillDamageType,
            skillHits = data.skillHits,
            skillDamageMultiplier = data.skillDamageMultiplier,
            skillCooldown = data.skillCooldown,
            skillMpCost = data.skillMpCost,
            skillHealPercent = data.skillHealPercent,
            skillHealFixed = data.skillHealFixed,
            skillHealType = data.skillHealType,
            skillBuffType = data.skillBuffType.ifEmpty { null },
            skillBuffValue = data.skillBuffValue,
            skillBuffDuration = data.skillBuffDuration,
            skillBuffsJson = data.skillBuffsJson,
            skillIsAoe = data.skillIsAoe,
            skillTargetScope = data.skillTargetScope,
            skillShieldPercent = data.skillShieldPercent,
            skillTurnAdvancePercent = data.skillTurnAdvancePercent,
            skillDamageSharePercent = data.skillDamageSharePercent,
            skillDamageLinkPercent = data.skillDamageLinkPercent,
            minRealm = data.minRealm,
            ownerId = data.ownerId.ifEmpty { null },
